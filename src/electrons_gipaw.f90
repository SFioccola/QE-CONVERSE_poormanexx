...
9121 FORMAT(/'     scf convergence threshold =',1PE17.1,' Ry' )
  !
END SUBROUTINE electrons_gipaw
!
!----------------------------------------------------------------------------
SUBROUTINE electrons_scf_gipaw ( printout, exxen )
  !----------------------------------------------------------------------------
     ...
     scf_step: DO
        ...
        IF ( lda_plus_u )  THEN
           ...
           IF (hub_pot_fix) THEN
             ...
             ELSEIF (lda_plus_u_kind.EQ.1) THEN
                CALL errore('electrons_scf_gipaw', &
...
9903 FORMAT( '     level-shifting contrib.   =',F17.8,' Ry' )
  ...
  !
END SUBROUTINE electrons_scf_gipaw
!
!----------------------------------------------------------------------------
